...
export default function Home() {
  return (
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll scroll-smooth">
        ...
        <Container>
          <div className="mx-2 md:mt-16 mb-30">
            ...
            <div className="flex gap-20 flex-col md:flex-row">
              <div className="text-md flex flex-col gap-6 p-6 rounded-xl mt-12 md:mt-12">
                <p>
      ...
      <section className="snap-start h-screen flex items-center justify-center px-2">
        <Container>
          <div className="mx-2 md:mt-20 mb-20">
            <h2 className="text-2xl md:text-2xl text-center font-bold text-zinc-800 mb-10">
              Melhores Soluções
            </h2>
      ...
      <section className="snap-start h-screen flex items-center justify-center px-2">
        <Container>
          <div className=" py-14 mt-10 md:mt-20 p-5 rounded-3xl mb-30">
      ...
      <section className="snap-start h-screen flex items-center justify-center px-2">
        <Container>
          <div className="mx-2 md:mt-16 mb-32 lg:mb-40">
            <h2 className="text-2xl md:text-2xl text-center font-bold text-zinc-800 mb-10 mt-16">
              Nossos Clientes
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 text-base md:text-lg">
              {[
